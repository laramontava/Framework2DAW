    ...
    <div class="navbar navbar-inverse navbar-fixed-top" >
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php?module=main">YOUR LOGO</a>
            </div>
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="index.php?module=products_frontend&function=list_products">LIST PRODUCTS</a></li>
                    <li><a href="index.php?module=products&view=create_products">CREATE PRODUCT</a></li>
